...
public final class CaminoJsonKey {


    public static final String TENANT_INFO_DB = "tenantInfoDb";
    public static final String TENANT_INFO_ID = "tenantInfoId";
    public static final String PREFERENCE_DETAILS = "preferenceDetails";
